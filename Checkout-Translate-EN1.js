...
"Title":{de:"Anrede"},
"Company":{de:"Firma"},
"Address addition":{de:"Adresszusatz"},
"State":{de:"Bundesland/Kanton"},
"VAT No.":{de:"USt-IdNr."},
"State":{de:"Bundesland/Kanton"},
...
"China":{de:"China"},
"Denmark":{de:"Dänemark"},
"Democratic People's Republic of Korea":{de:"Demokratische Volksrepublik Korea"},
...
"East Timor":{de:"Osttimor"},
"Pakistan":{de:"Pakistan"},
"Philippines":{de:"Philippinen"},
"Poland":{de:"Polen"},
"Portugal":{de:"Portugal"},
"Republic of Korea":{de:"Republik Korea"},
"Republic of Moldova":{de:"Republik Moldau"},
"Romania":{de:"Rumänien"},
"Russian Federation":{de:"Russische Föderation"},
...
"Select a payment method.":{de:"Zahlungsmethode auswählen."},
"PayPal (credit card, direct debit, bank transfer)":{de:"PayPal (Kreditkarte, Lastschrift, Überweisung)"},
"Bank transfer":{de:"Gegen Vorkasse"},
"Shipping costs:<small></small>":{de:"Versandkosten:"},
